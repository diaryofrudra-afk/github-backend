    ...
    try:
        ...
        if row:
            try:
                ...
                logger.warning(f"InvalidToken when decrypting Blackbuck credentials for user {user_id}. Secret may have changed.")
                return None
    except Exception as e:
        logger.error(f"Error fetching Blackbuck credentials for user {user_id}: {e}")
