                  ...
                  <div className="op-history-asset">
                    {hasLogbook ? (
                      <button className="op-history-asset-btn" onClick={() => setViewerFileId(e.id)}>
                        <span className="material-symbols-outlined" style={{ fontSize: '18px', marginRight: '6px' }}>assignment</span>
                        Logbook Attached
                      </button>
                    ) : (
                    ...
                    <span className="material-symbols-outlined op-history-asset-chevron">chevron_right</span>
                  </div>
                </div>
              );
            })}
