      ...
      <div className={`auth-container ${mode === 'register' ? 'active' : ''}`} id="auth-container">
        ...
        <div className="form-container sign-in-form">
          <form onSubmit={handleSubmit}>
            ...
            <div className="divider"><span>testing mode</span></div>

            <button type="button" className="google-btn test-login-btn" onClick={handleTestLogin} disabled={authLoading}>
              <svg className="google-icon" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#10b981" strokeWidth="2">
