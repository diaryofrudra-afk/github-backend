...
const CRANE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:32px;height:32px;display:block;filter:drop-shadow(0 2px 4px rgba(0,0,0,0.5));"><line x1="9" y1="22" x2="9" y2="4"/><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="6" x2="4" y2="6"/><line x1="9" y1="3" x2="20" y2="6"/><line x1="9" y1="3" x2="4" y2="6"/><line x1="16" y1="6" x2="16" y2="13"/><path d="M14.5 12.5 Q14.5 15.5 16 15.5 Q17.5 15.5 17.5 12.5" fill="none"/><line x1="6" y1="22" x2="12" y2="22"/></svg>`;
  ...
  return L.divIcon({
    ...
    html: `<div style="position:relative;display:flex;flex-direction:column;align-items:center;">
      <div style="position:relative;width:36px;height:36px;display:flex;align-items:center;justify-content:center;">
        ${CRANE_SVG}
        <span style="position:absolute;bottom:0;right:0;width:8px;height:8px;border-radius:50%;background:${color};border:2px solid #111;box-shadow:0 0 3px rgba(0,0,0,0.4);"></span>
        ${engineDot}
      </div>
